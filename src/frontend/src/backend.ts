...
export class Backend implements backendInterface {
    ...
    async addBakingTip(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addBakingTip(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTestimonial(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getBakingTips(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBakingTips();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getShopOpenings(): Promise<Array<ShopOpening>> {
        if (this.processError) {
            try {
                const result = await this.actor.getShopOpenings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTestimonials(): Promise<Array<string>> {
        if (this.processError) {
            try {
